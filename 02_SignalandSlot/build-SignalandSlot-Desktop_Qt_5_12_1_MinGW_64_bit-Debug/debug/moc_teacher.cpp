...
#include "../../SignalandSlot/teacher.h"
...
QT_MOC_LITERAL(1, 8, 7), // "hungery"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4) // "food"

    },
    "Teacher\0hungery\0\0food"
};
...
void Teacher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->hungery((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Teacher::hungery)) {
                *result = 0;
                return;
            }
        }
